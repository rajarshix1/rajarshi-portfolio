...
function HomeScreen() {
  ...
  return (
    <div id="home" className="scroll-mt-32 min-h-screen flex flex-col items-center md:justify-center md:flex-row  pt-16 md:pt-20 px-6 md:px-10">
      <div className="flex flex-col space-y-2 md:space-y-4 mb-4 md:mr-2 w-full md:w-7/12 ">
        <p className={`bg-gradient-to-br ${darkTheme? 'from-violet-400 to-pink-200 ' : 'from-violet-800 to-pink-600' } bg-clip-text text-transparent text-6xl`}>Welcome</p>
        <p className={`bg-gradient-to-br ${darkTheme? 'from-violet-300 to-slate-50' : 'from-violet-800 to-slate-500'} bg-clip-text text-transparent text-5xl`}>To my Portfolio!</p>
