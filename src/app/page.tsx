  ...
  return (
    <div className="flex flex-col  bg-secondary  h-full font-mono">
      ...
      <div className="flex flex-col space-y-4 mb-4 md:mr-2 w-full md:w-7/12 ">
        ...
        <button className="px-3 py-2 w-fit rounded-3xl bg-primary hover:bg-red-700 hover:cursor-pointer">Contact Me</button>
        <a className="px-3 py-2 w-fit rounded-3xl bg-blue-700 hover:bg-red-700 hover:cursor-pointer flex items-center justify-center" href="/Resume-Rajarshi-BE.pdf" download><button >View Resume</button></a>
        </div>
      </div>
