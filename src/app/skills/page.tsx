...
export default function Projects() {
  ...
  return (
    <div className={`flex flex-col h-full font-mono ${darkTheme ? `bg-secondary text-accent` : `bg-white text-blue-950`}`}>
      ...
      <div className='my-4'>
        <div className='flex items-center justify-center w-full mb-3'>
          <p className='bg-gradient-to-br from-blue-500 to-fuchsia-300 bg-clip-text text-transparent text-2xl'>✨Front-end + App✨</p>
        </div>
        <div className='flex flex-col md:justify-center items-center md:flex-row space-y-2 md:space-y-0 md:space-x-4'>
          <MediaCard title="React.js" image="/react.png" description="3+ years of experience" shadow="shadow-emerald-400" />
          <MediaCard title="Next.js" image="/next.png" description="3+ years of experience" shadow="shadow-yellow-400" />
          <MediaCard title="Tailwind" image="/tailwind.png" description="3+ years of experience" shadow="shadow-red-400" />
          <MediaCard title="React Native" image="/reactnative.png" description="A few months of experience" shadow="shadow-blue-400" />
        </div>
      </div>
    </div>
  )
